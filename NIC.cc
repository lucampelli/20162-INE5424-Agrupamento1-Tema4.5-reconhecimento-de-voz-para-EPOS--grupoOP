...
static const IEEE802_15_4::Protocol PROTOCOL = 42;

void sender()
{
    char data[] = "123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890";
//com 120 bytes de dados percebeu-se que só são enviados 116 bytes
    NIC * nic = new NIC();
    ...
    while(1)
    {
        ...
        nic->send(nic->broadcast(), PROTOCOL, data, sizeof data);
        cout << "Sent" << endl;
...
void receiver()
{
    ...
    NIC * nic = new NIC();
    Receiver * r = new Receiver(PROTOCOL, nic);
}
